<div class="modal fade text-center" id="deleteModal{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="warningModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Annuler</button>
                 <form action="{{route('flotte.user.destroy',$value->id)}}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
