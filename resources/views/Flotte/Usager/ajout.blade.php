        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content text-center">
                ...
                <div class="modal-body">
                                <form action="{{route('flotte.usager.store')}}" method="POST" class="form-material m-t-40 row">
                                    @csrf
                                    <div class="form-group col-md-6 m-t-20">
                                        <label for="nom">NOM</label>
                                        <input name="nom" type="text" class="form-control form-control-line"> </div>

                                        <div class="form-group col-md-6 m-t-20">
                                        <label for="prenom">PRENOM</label>
                                        <input name="prenom" type="text" class="form-control form-control-line"> </div>

                                        <div class="form-group col-md-6 m-t-20">
                                        <label for="direction">DIRECTION</label>
                                        <input name="direction" type="text" class="form-control form-control-line"> </div>

                                        <div class="form-group col-md-6 m-t-20">
                                        <label for="service">SERVICE</label>
                                        <input name="service" type="text" class="form-control form-control-line"> </div>

                                    <div class="form-group col-md-6 m-t-20">
                                        <label for="offre">OFFRE</label>
                                        <select name="id_offre" class="form-control form-control-line text-center" >
                                            @foreach($offre as $offre)
                                            <option value="{{$offre->id}}">{{$offre->offre}}</option>
                                            @endforeach
                                        </select> </div>

                                    <div class="form-group col-md-6 m-t-20">
                                        <label for="id_puce"><i class="fa  fa-mobile-phone (alias)"> </i> CARTE SIM</label>
                                        <select name="id_puce" class="form-control form-control-line text-center" >
                                            @foreach($puce as $puce)
                                            <option value="{{$puce->id}}">{{$puce->numero}}</option>
                                            @endforeach
                                        </select> </div>
                                    ...
                                    <div class="form-group col-md-6 m-t-20">
                                        ...
                                        <select name="forfait_id" class="form-control form-control-line text-center" >
                                            ...
                                            <option value="{{$forfaits->id}}">{{$forfaits->nomforfait}}-- {{$forfaits->volume}} -- {{$forfaits->prix}}Ar</option>
                                            @endforeach
                                        </select> </div>

                                        <div class="form-group col-md-6 m-t-20">
                                        <label for="consommation">CONSOMMATION</label>
                                        <input name="consommation" type="text" class="form-control form-control-line"> </div> 

                                        <div class="form-group col-md-6 m-t-20">
                                        <label for="localite">LOCALITE</label>
                                        <input name="localite" type="text" class="form-control form-control-line"> </div>         
