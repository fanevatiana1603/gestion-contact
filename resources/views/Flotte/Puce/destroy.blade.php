<div class="modal fade text-center" id="deleteModal{{$puce->id}}" tabindex="-1" role="dialog" aria-labelledby="warningModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Annuler</button>
                 <form action="{{route('flotte.puce.destroy',$puce->id)}}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
